package strategy.controller.commands.surpriseconsequences {
	...
	public class AdjustDayProductivityCommandTest extends TestCase {
		private var instance:AdjustDayProductivityCommand;
		private const PRODUCTIVITY:Number = -23;

		public function AdjustDayProductivityCommandTest(methodName:String=null) {
			super(methodName)
		}
		...
		override protected function setUp():void {
			super.setUp();
			instance = new AdjustDayProductivityCommand();
		...
		public function testInstantiated():void {
			assertTrue("instance is AdjustDayProductivityCommand", instance is AdjustDayProductivityCommand);
		}
		...
		public function testExecute():void {
			instance.execute(); 
			verify(instance.labour).method("changeTodaysProductivityBy").args(equalTo(PRODUCTIVITY));
		}
	}
}