package strategy.view.decisions {
	...
	public class StoneOfferViewTest extends TestCase {
		private var instance:StoneOfferView;
		...
		public function StoneOfferViewTest(methodName:String=null) {
			super(methodName)
		}

		override protected function setUp():void {
			super.setUp();
			instance = new StoneOfferView(PRICE, AVAILABILITY);
			submitFired = false;
		}
		...
		public function testInstantiated():void {
			assertTrue("instance is StoneOfferView", instance is StoneOfferView);
		}
